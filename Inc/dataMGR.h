...
#define MISC_SIG_AUX_INPUT	0x00000010U
#define MISC_SIG_EXT1				0x00000020U
#define MISC_SIG_EXT2				0x00000040U
#define MISC_SIG_EXT3				0x00000080U
#define MISC_SIG_UNDERVOLT	0x00000100U
#define MISC_SIG_SD_OVR			0x00000200U
#define MISC_SIG_SD_ERR			0x00000400U
#define MISC_SIG_PREV_OVR		0x00000800U
#define MISC_SIG_LD1				0x00001000U
#define MISC_SIG_LD2				0x00002000U
...
typedef struct{
  ...
  float trigger_gain;
	...
	ulong system_status;
	ulong stim_intensity;
	ulong unassigned[89];		//unassigned
}CE32_systemParam;
...
void CE32_arbitar_Init(uchar** ch_ord,void (**arbitarCal_CH)(uchar* ch_ord,short* data,float* output),CE32_dspParam* sysDSP);
